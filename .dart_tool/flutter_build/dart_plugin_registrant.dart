...
import 'package:swift_camera_android/swift_camera_android.dart';
import 'package:path_provider_android/path_provider_android.dart';
import 'package:shared_preferences_android/shared_preferences_android.dart';
import 'package:webview_flutter_android/webview_flutter_android.dart';
import 'package:swift_camera_avfoundation/swift_camera_avfoundation.dart';
...
class _PluginRegistrant {
  ...
  static void register() {
    if (Platform.isAndroid) {
      try {
        SwiftAndroidCamera.registerWith();
      } catch (err) {
        print(
          '`swift_camera_android` threw an error: $err. '
      ...
      try {
        SwiftAVFoundationCamera.registerWith();
      } catch (err) {
        print(
          '`swift_camera_avfoundation` threw an error: $err. '
          'The app may not function as expected until you remove this plugin from pubspec.yaml'
        );
      }
