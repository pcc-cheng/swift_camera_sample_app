...
@interface SwiftFLTImageStreamHandler : NSObject <FlutterStreamHandler>
...
/// SwiftFLTSavePhotoDelegate that handles the result of each photo capture operation. Note that photo
/// capture operations may overlap, so SwiftFLTCam has to keep track of multiple delegates in progress,
/// instead of just a single delegate reference.
@property(readonly, nonatomic)
    NSMutableDictionary<NSNumber *, SwiftFLTSavePhotoDelegate *> *inProgressSavePhotoDelegates;
...
- (void)startImageStreamWithMessenger:(NSObject<FlutterBinaryMessenger> *)messenger
                   imageStreamHandler:(SwiftFLTImageStreamHandler *)imageStreamHandler;

- (NSString *)rotatedImage:(NSString *)imagePath;
