...
#import "SwiftCameraPlugin.h"
#import "FLTCam.h"
#import "FLTThreadSafeFlutterResult.h"

/// APIs exposed for unit testing.
@interface SwiftCameraPlugin ()

/// All SwiftFLTCam's state access and capture session related operations should be on run on this queue.
@property(nonatomic, strong) dispatch_queue_t captureSessionQueue;

/// An internal camera object that manages camera's state and performs camera operations.
@property(nonatomic, strong) SwiftFLTCam *camera;
...
/// Creates SwiftFLTCam on session queue and reports the creation result.
