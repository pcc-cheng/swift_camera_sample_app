 ...
 */
@interface SwiftFLTCam : NSObject <FlutterTexture>
...
- (void)captureToFile:(FLTThreadSafeFlutterResult *)result rotateImage:(BOOL)rotateImage;
- (void)close;
...
- (void)setWhiteBalanceModeWithResult:(FLTThreadSafeFlutterResult *)result mode:(NSString *)modeStr;
- (void)setWhiteBalanceCustomGainsWithResult:(FLTThreadSafeFlutterResult *)result redGain:(double)redGain greenGain:(double)greenGain blueGain:(double)blueGain;
- (void)getFieldOfViewWithResult:(FLTThreadSafeFlutterResult *)result;
- (void)getMinExposureDurationWithResult:(FLTThreadSafeFlutterResult *)result;
- (void)getMaxExposureDurationWithResult:(FLTThreadSafeFlutterResult *)result;
- (void)getCurrentExposureDurationWithResult:(FLTThreadSafeFlutterResult *)result;
- (void)setExposureDurationWithResult:(FLTThreadSafeFlutterResult *)result duration:(double)duration;
- (void)getMinISOWithResult:(FLTThreadSafeFlutterResult *)result;
- (void)getMaxISOWithResult:(FLTThreadSafeFlutterResult *)result;
- (void)getCurrentISOWithResult:(FLTThreadSafeFlutterResult *)result;
- (void)setISOWithResult:(FLTThreadSafeFlutterResult *)result ISO:(double)ISO;
