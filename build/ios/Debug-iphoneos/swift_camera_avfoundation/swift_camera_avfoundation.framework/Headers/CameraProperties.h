...
/**
 * Represents camera's white balance mode. Mirrors WhiteBalanceMode in camera.dart.
 */
typedef NS_ENUM(NSInteger, FLTWhiteBalanceMode) {
  FLTWhiteBalanceModeAuto,
  FLTWhiteBalanceModeLocked,
};

/**
 * Gets a string representation from FLTWhiteBalanceMode.
 * @param mode white balance mode
 */
extern NSString *FLTGetStringForFLTWhiteBalanceMode(FLTWhiteBalanceMode mode);

/**
 * Gets FLTWhiteBalanceMode from its string representation.
 * @param mode a string representation of white balance mode.
 */
extern FLTWhiteBalanceMode FLTGetFLTWhiteBalanceModeForString(NSString *mode);
